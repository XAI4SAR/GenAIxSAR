...
writer = SummaryWriter('../tensorboard/'+'DRAGAN')
...
def compute_gradient_penalty(D, X):
    ...
    fake = Variable(torch.ones(d_interpolates.size(), requires_grad=False).cuda())
    ...
    for epoch in range(train_epoch):
        ...
        for idx, data in enumerate(train_loader):
            ...
            for d_index in range(d_steps):
                ...
                gradient_penalty = compute_gradient_penalty(D, x_data)
