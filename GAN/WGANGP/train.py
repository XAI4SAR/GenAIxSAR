...
for epoch in range(train_epoch):
    ...
    for idx, data in enumerate(train_loader):
        ...
        for d_index in range(d_steps):
            ...
            D_train_loss = ( D_fake_loss - D_real_loss + gradient_penalty) + 5*(C_real_loss + C_fake_loss) + 20*(A_real_loss + A_fake_loss) + one2onemapping(x_re,x_data)
